...
<body>
<?php include('reg_head1.php');?></br></br></br></br>

<div class="container">
<h2 style="font-family:Verdana, Geneva, sans-serif"><b>DEVELOPER</b></h2></br>
<div class="col-md-3">
<img src="imgwel/1.jpg" class="img-thumbnail img-circle"/></br></br>
</div></div>
<div class="container">
<h3></p>
...
</p></h3></br></br></br></br></br></br>
<h3 style="font-family:Georgia, 'Times New Roman', Times, serif"><b>ukansuccess@gmail.com</br></br><a href="notes/disclaimer.pdf" class="btn btn-primary" style="background-color:#333" target="_blank">Disclaimer</a></b></h3>
</div></br></br></br> 
...
<div>
   <center>
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" value="Subscribe" id="subscribe" name="subsc"></form>
    </center>
</div>
<?php 
